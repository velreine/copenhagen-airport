        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AirlineCompany>(entity =>
            {
                ...
                entity.HasIndex(e => e.Name)
                    .HasName("UQ__airline___72E12F1BF1E1512B")
                    .IsUnique();
            ...
            modelBuilder.Entity<Airport>(entity =>
            {
                ...
                entity.HasIndex(e => e.Iata)
                    .HasName("UQ__airport__9874D234577E773B")
                    .IsUnique();
            ...
            modelBuilder.Entity<Departure>(entity =>
            {
                ...
                entity.HasOne(d => d.Operator)
                    ...
                    .HasConstraintName("FK__departure__opera__693CA210");

                entity.HasOne(d => d.Route)
                    .WithMany(p => p.Departure)
                    .HasForeignKey(d => d.RouteId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__departure__route__68487DD7");
            });
            ...
            modelBuilder.Entity<ExtraPermittedRouteOperators>(entity =>
            {
                ...
                entity.HasOne(d => d.AirlineCompany)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__extra_per__airli__6477ECF3");

                entity.HasOne(d => d.Route)
                    .WithMany(p => p.ExtraPermittedRouteOperators)
                    .HasForeignKey(d => d.RouteId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__extra_per__route__656C112C");
            });
            ...
            modelBuilder.Entity<Route>(entity =>
            {
                ...
                entity.HasOne(d => d.Destination)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__route__destinati__5EBF139D");

                entity.HasOne(d => d.Origin)
                    .WithMany(p => p.RouteOrigin)
                    .HasForeignKey(d => d.OriginId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__route__owner_ope__5DCAEF64");
            });
